...
int GeometryGen::generateShadowVolume(LIGHT_PTR l_in, int num_l_in, OBJECT4D_PTR objShadowCaster_in, OBJECT4D_PTR objShadowVol_inout, int sh_vol_num_in)
{
	...
	{
		this->frontBackFace.resize(this->frontBackFace.size(), 0); //Для правильной работы с атрибутами
	}
	...
	//vecScale(100000000000000000000000.f, &vl);
	//vecScale(1000000000000000000000000000000000.f, &vl);
	//vecScale(1000000, &vl);
